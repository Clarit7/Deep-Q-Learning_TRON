...
parser.add_argument('--entropy-weight', type=float, default=0.0002, metavar='β', help='Entropy regularisation weight')
...
if __name__ == '__main__':
  ...
  env_tron = make_static_game(True)
  shared_model_tron = NetStatic10()
  shared_model_tron.share_memory()
  if args.model and os.path.isfile(args.model):
    # Load pretrained weights
    shared_model_tron.load_state_dict(torch.load(args.model))
  # Create average network
  shared_average_model_tron = NetStatic10()
  ...
  optimiser_tron = SharedRMSprop(shared_model_tron.parameters(), lr=args.lr, alpha=args.rmsprop_decay)
