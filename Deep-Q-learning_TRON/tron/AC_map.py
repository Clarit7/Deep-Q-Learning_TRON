...
class Tile(Enum):
    ...
    PLAYER_TWO_BODY = 3
    PLAYER_TWO_HEAD = 4
    PLAYER_ONE_CRASHED = 5
    PLAYER_TWO_CRASHED = 6
    HEAD_CRASHED = 7
    ...
    def color(self):
        ...
        if self == Tile.EMPTY:
            ...
            return (255, 34, 0)
        elif self == Tile.PLAYER_ONE_CRASHED:
            return (0, 34, 120)
        elif self == Tile.PLAYER_TWO_CRASHED:
            return (120, 34, 0)
        elif self == Tile.HEAD_CRASHED:
            return (120, 120, 120)
        else:
            return None
...
class Map:
    ...
    def color(self, t, p):
        ...
        elif t == Tile.PLAYER_ONE_CRASHED:
            return 20 if p == 1 else -20
        elif t == Tile.PLAYER_TWO_CRASHED:
            return 20 if p == 2 else -20
        elif t == Tile.HEAD_CRASHED:
            return 0
        else:
            return None
